  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(itemBuilder: (context,index)=> HistoryCard(bankName: 'bankName', date: DateTime.now().toString(), cash: index * 121, currency: 'TMT', remark: 'this is remark for history card',)),
      )
